...
CARD_LIBRARY = [
    ...
    CardDef(
        ...
        "Bluff",
        CardType.ENCOUNTER,
        "Talk a big game and bank on nobody actually checking.",
        "Confidence over fact.",
        1.0,
    ),
    CardDef(
        "guile_forge",
        "Forge It",
        CardType.ENCOUNTER,
        "Produce the missing document yourself. Close enough.",
        "Looks official.",
        1.0,
    ),
    CardDef(
        ...
        "Play Dumb",
        CardType.ENCOUNTER,
        "Smile, claim total ignorance, let someone else own it.",
        "Who, me?",
        1.0,
    ),
    CardDef(
        ...
        "Name-Drop",
        CardType.ENCOUNTER,
        "Invoke someone important who maybe, possibly, said this.",
        "The DG wants it.",
        1.0,
    ),
    CardDef(
        ...
        "Find a Loophole",
        CardType.ENCOUNTER,
        "Read the policy until it says what you need it to.",
        "Section 7, subsection b.",
        1.0,
    ),
    # ── FORCE (pushy / aggressive) ─────────────────────────────────────────────
    CardDef(
        "force_escalate",
        "Escalate",
        CardType.RIVAL,
        "Take it straight over their head to the boss.",
    ...
    CardDef(
        ...
        "Demand It",
        CardType.RIVAL,
        "Insist, loudly, that this happens right now.",
        "No, today.",
        1.0,
    ),
    CardDef(
        ...
        "Stand Firm",
        CardType.RIVAL,
        "Refuse to move until they cave.",
        "I'll wait.",
        1.0,
    ),
    CardDef(
        ...
        "Make a Scene",
        CardType.RIVAL,
        "Kick up enough fuss that 'yes' is easier than 'no'.",
        "Everyone's looking.",
        1.0,
    ),
    CardDef(
        ...
        "Call a Meeting",
        CardType.RIVAL,
        "Summon everyone responsible into one room until it's settled.",
        "Recurring, mandatory.",
        1.0,
    ),
    # ── PROCESS (proper / by-the-rules) ────────────────────────────────────────
    CardDef(
        "proc_bythebook",
        "By the Book",
        CardType.BOON,
        "Find the correct form. Fill it out. Submit in triplicate.",
        "As per policy.",
        1.0,
    ),
    CardDef(
        ...
        "Charm Them",
        CardType.BOON,
        "Be so genuinely pleasant they want to help you.",
        "How's the family?",
        1.0,
    ),
    CardDef(
        ...
        "Delegate",
        CardType.BOON,
        "Make it, officially, somebody else's job.",
        "Looping you in.",
        1.0,
    ),
    CardDef(
        ...
        "Paper Trail",
        CardType.BOON,
        "Document everything until the problem has to move.",
        "Cc: everyone.",
        1.0,
    ),
    CardDef(
        ...
        "Just Ask Nicely",
        CardType.BOON,
        "Politely ask the one person who can actually do it.",
        "Please and thank you.",
        1.0,
    ),
    # ── WILDCARD (chaotic / risky) ─────────────────────────────────────────────
    CardDef(
        "wild_bribe",
        "Bribe",
        CardType.TWIST,
        "Coffee, donuts, or a vague future favour.",
        "Two sugars?",
        1.0,
    ),
    CardDef(
        ...
        "Sabotage",
        CardType.TWIST,
        "Quietly make the obstacle someone else's problem.",
        "Oops.",
        1.0,
    ),
    CardDef(
        ...
        "Skip the Process",
        CardType.TWIST,
        "Ignore the proper channel entirely. Beg forgiveness later.",
        "Easier to apologize.",
        1.0,
    ),
    CardDef(
        ...
        "Lie Low",
        CardType.TWIST,
        "Wait it out and hope the problem forgets itself.",
        "Maybe it resolves.",
        1.0,
    ),
    CardDef(
        ...
        "Go Rogue",
        CardType.TWIST,
        "Ignore every rule and just DO the thing.",
        "No more forms.",
        1.0,
    ),
]
