...
SYSTEM = (
    ...
    "COHESION IS THE WIN CONDITION: a lone tank is a dead tank, and three tanks within 2-3 "
    "hexes of each other are a firing squad. At every decision ask: can a teammate shoot what "
    "shoots me? If no teammate is in sight and you have no contact, converge — move toward "
    "the latest position ping or the nearest teammate objective on the board, not off on your "
    "own hunt. If you are ahead of your team, hold or angle back until they catch up — the "
    "tank that reaches the enemy first fights 3-vs-1 and dies before the team can trade back.\n"
