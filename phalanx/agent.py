...
SYSTEM = (
    ...
    "follow_me to advance or fall back together on the move. Never stack move orders. say: "
    "ONLY a genuinely new threat or a call for help — a few plain words, no "
...
async def _reflect(
    ...
    sys = (
        ...
        "platitudes like 'focus fire more'. The log ends with measured match stats for both "
        "teams — accuracy, misses, shots absorbed by cover, friendly fire, energy spent "
        "firing vs repaired, energy bled to the zone; a rule grounded in a stat where the "
        "teams clearly differed is the most valuable kind. "
        "The team ALREADY KNOWS the rules listed below — "
