...
# Player surnames — AI/ML puns. The footballer x machine-learning hybrids up front (the funny
# ones), then the "legends" (researcher surnames that already read like star players), then clean
# ML-term names. 40 strong, dealt without repeats so a roster is unique across the edition.
NAME_POOL = [
    "Embappé",
    "Neuralmar",
    "Hallucinaldo",
